    ...
    <div className="route-calculator">
      ...
      <div className="route-controls">
        ...
        >
          ...
          <option value="SimulatedAnnealing">Simulated Annealing Algorithm</option>
          <option value="Savings">Savings Algorithm</option>
        ...
        {route.length > 0 && (
          <p>
            Depot ID: {route[0].originId}, Latitude: {route[0].latitude},
            Longitude: {route[0].longitude}
          </p>
        )}
        {route.map((leg, index) => (
          <p key={index}>
            Stop {index + 1}: from ID: {leg.originId} to ID: {leg.destinationId},
            Latitude: {leg.destLatitude}, Longitude: {leg.destLongitude},
...
const formatCalculationTime = (milliseconds) => {
  ...
  return (
    ...
    `${remainingMilliseconds} millisecond${
